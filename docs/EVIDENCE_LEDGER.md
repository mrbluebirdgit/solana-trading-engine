...
- Solana [token](https://solana.com/docs/tokens), [freeze-account](https://solana.com/docs/tokens/basics/freeze-account), and [Token-2022](https://www.solana-program.com/docs/token-2022) documentation defines authority and extension capabilities. Active freeze authority, permanent delegate, transfer hook, transfer fee, pausing or non-transferability is factual state; excluding a capability is a risk policy, not a fraud verdict.
- Pump.fun's [official public docs and IDLs](https://github.com/pump-fun/pump-public-docs) define the program accounts, curve state and migration mechanics. Verify those relationships from chain data and pin the deployed version.
