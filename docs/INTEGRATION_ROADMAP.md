...
| 11 | Solscan API | Candidate metadata, holder/authority corroboration, and last-resort outcome prices | `SOLSCAN_API_KEY` on the user's free plan | Candidate-triggered Pro v2 adapter, persisted quota budget, read verifier, and price fallback implemented |
